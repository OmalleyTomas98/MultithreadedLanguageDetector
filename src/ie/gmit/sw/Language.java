 ...
 * @since 1.8
 * 
 *        Public enum <i>'enumaration'</i> is a enum class which holds a final
 *        list of languages which are hoped to be returned in our parser
 */

public enum Language {

	/**
	 * The list of <b>final</b> languages which never change
	 * 
	 */
	...
	/**
	 * 
	 * Private CharSequence holds the language
	 */
